  ...
  textWrapper: {
    ...
    children: [
      ...
      },
      {
        ...
        children:'强大的讲师阵容精准解决学员各种疑难杂症， 现在预约课程线上收益还会获得8%返利助学计划'
      },
      { name: 'button', className: 'banner3-button', children: '立即预约' },
      {
        name: 'time',
...
export const Content80DataSource = {
  ...
  titleWrapper: {
    ...
    children: [
      ...
      { name: 'title', children: '讲师阵容', className: 'title-h1' },
    ],
  },
  block: {
...
export const Content90DataSource = {
  ...
  titleWrapper: {
    ...
    children: [
      ...
      { name: 'title', children: '公司历程', className: 'title-h1' },
    ],
  },
  block: {
    className: 'timeline',
    children: [
      {
        ...
        children: {
          ...
          time: { className: 'block-time', children: '2016年' },
          title: { className: 'block-title', children: '初始' },
          content: { className: 'block-content', children: '组建4人创业团队，入驻少儿编程线下培训， 培养了一批优秀的青少年学员' },
        },
      },
      {
        name: 'block1',
        ...
        children: {
          ...
          name: { className: 'block-name', children: '姓名' },
          post: { className: 'block-post', children: '公司 职位' },
          time: { className: 'block-time', children: '2017年' },
          title: { className: 'block-title', children: '成长' },
          content: {
            className: 'block-content',
            children:
              '团队建设到 20人规模，汇集清北名牌大学的讲师， BAT 资深开发者于产品建设， 给更多初学者带来编程技术福音',
          },
        },
      },
      {
        ...
        children: {
          ...
          name: { className: 'block-name', children: '姓名' },
          post: { className: 'block-post', children: '公司 职位' },
          time: { className: 'block-time', children: '2018年' },
          title: { className: 'block-title', children: '突破' },
          content: {
            className: 'block-content',
            children:
              '历经两年线下少儿编程培训， 转战线上教育， 主打定制，一对一， 以及线上线下相结合的方式， 目前线下用户量已达到3000+， 线上注册日活用户接近20000人， 定制课程好评率100%， 解决了所有初学者疑问和难点',
          },
        },
      },
      {
        ...
        children: {
          ...
          name: { className: 'block-name', children: '姓名' },
          post: { className: 'block-post', children: '公司 职位' },
          time: { className: 'block-time', children: '2019年' },
          title: { className: 'block-title', children: '腾飞' },
          content: {
            className: 'block-content',
            children:
              '知修科技挂牌成立， 线上资源整合到指定域 www.icode121.com (爱编程，一对一) ， 团队继续扩大',
          },
        },
      },
    ],
